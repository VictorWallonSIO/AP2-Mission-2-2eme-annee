            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        ...
                        <h3 class="post-subtitle">Bienvenue sur la BDD des practiciens de Bretagne <br> <br> Vous pouvez gérer tout les practiciens 
                        de la région avec les options qui vous sont proposé sur la page de gestion </h3>
